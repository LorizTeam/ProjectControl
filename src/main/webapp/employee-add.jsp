...
<html>
	<head>
		<title>Project Controller : Add Employee</title>
		<meta charset="utf-8">
	...
	<body>
		...
		<main>
		    ...
		    <div class="div-container ">
				...
				<h4 class="center-align light-blue-text text-darken-1">Add Employee</h4>
		...
		<script type="text/javascript">
		 $(document).ready(function(){
			 $('.m5').addClass('active');
			 $('.m5-2').addClass('active');
			 $('.collapsible').collapsible();
			 $('.page-title').text('Add Employee');
